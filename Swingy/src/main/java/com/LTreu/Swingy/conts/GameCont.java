...
import com.LTreu.Swingy.views.consoleViews.ConsoleDisplay;
import com.LTreu.Swingy.views.guiViews.GuiDisplay;
...
public class GameCont
{
    ...
    private void createVillains()
    {
        ...
        for (int i = 0; i < numVillains; i++)
        {
            ...
            String names[] = {"General Zod","Lex Luthor", "The Joker", "Darth Vader"},
                    phrases[] = {"Kneel before Zod", "The world can do without Superman", "Why so serious!?", "Luke, I am your father"};
